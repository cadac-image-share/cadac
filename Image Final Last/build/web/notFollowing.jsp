    ...
    <body>
        <div class="container">
            <header class="clearfix">
                ...
                <h3> Yahooooo , ${username}!  this user exists in our image world , you can follow him if you want ...  </h3>
...
<body>
	<center>
		<h3> Hey  ${username} , you can follow ${tempname} to keep him in nearby in you virtual world</h3>
		<h2>This user resides in our databases :-) </h2>
		<form method="post" action="followUser" >
			<table border="0">
                            <input type="hidden" value="${enteredUser}" name="followUser"/>
                                <tr>
                                <td colspan="2">
