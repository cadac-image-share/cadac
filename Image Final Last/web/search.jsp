	...
	<center>
		...
		<form method="post" action="Search" >
			<table border="0">
                ...
                <h5>Search Image results will also be stored in </h5>
                <h5>  C:\Users\ankursmooth\Documents\Netbeans projects\Image Final Last\web\searchresult\ after retrieval from ibm db2</h5> 
	</center>
</body>
</html>