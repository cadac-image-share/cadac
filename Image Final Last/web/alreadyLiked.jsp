    ...
    <body>
        <div class="container">
            <header class="clearfix">
                ...
                <span>ALready Liked <span class="bp-icon bp-icon-about" data-content="Where you can see the posts by your friends!"></span></span>
...
<body>
<center>
    <h3> Hey  ${username} , maybe you forgot ! you have already added ${tempname} into the bucket </h3>
</center>
</body>
</html>