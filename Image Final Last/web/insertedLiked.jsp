    ...
    <body>
        <div class="container">
            <header class="clearfix">
                ...
                <span>Pic added to bucket <span class="bp-icon bp-icon-about" data-content="Where you can see the posts by your friends!"></span></span>
...
<body>
<center>
    <h3> Hey  ${username} , we have successfully added image with id - ${tempname} into your bucket</h3>
    <br>
    <h3> This image will get preferential treatment in your timeline. </h3>
    <h3> It will appear earlier in your timeline as compared to other pics. </h3>
</center>
</body>
</html>