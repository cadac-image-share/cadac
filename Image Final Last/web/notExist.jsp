    ...
    <body>
        <div class="container">
            <header class="clearfix">
                ...
                <h3> Sorry , ${username}!  the given user does not live in our database , :-( </h3>
                <!--<c:set var="path" value=(String)filenames.get(0);/>-->
                <!--String path_set="img/thumb/"+(String)filenames.get(0);-->
                <!--(String)filenames.get(0)%>-->
                <span>Not found <span class="bp-icon bp-icon-about" data-content="Where you can see the posts by your friends!"></span></span>
...
<body>
	<center>
		...
		<h2> ${tempname} does not exist in our databases, if you know him tell him about us </h2>
